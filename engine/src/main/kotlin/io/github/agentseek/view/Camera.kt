...
class Camera(
    ...
    private var worldPosition: Point2d = Point2d.origin(),
) {
    ...
    fun toCameraPoint(worldPoint: Point2d): Point2d {
        val cameraX = (worldPoint.x * view.screenWidth) / worldViewPortWidth
        val cameraY = (worldPoint.y * view.screenHeight) / worldViewPortHeight
